...
--Panime välja võimaliku vanusevahemiku
alter table Person
...
--kustutasime kasutaja, kellel oli ID=8
select * from Person
go
...
--Valime kõiki tabelist person kellel, nimi ei alga tähtega 'W' 'A' 'S'
select * from Person where Name like '[^WAS]%'
--- Valime kõiki tabelist person, kes elab Gotham'is või New York'is ja nad on vanem kui 40
...
--sorteerime kõiki tabelis PERSON vanuse järgi
select * from Person order by cast(Age as int)
select * from Person order by Age

--võtame kõigi tabelist PERSON vanused kokku
...
--loome protseduur, mis loendab genderi Id
...
---protseduur, mis loendab kõki id
