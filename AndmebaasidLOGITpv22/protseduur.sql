...
--
-- Host: 127.0.0.1
-- Loomise aeg: Aprill 17, 2024 kell 01:13 PL
...
--
-- Andmebaas: `kinoteatrkhachatryan`
--
...
-- Toimingud
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_filmid` (IN `pikkus_val` INT(1))   BEGIN
DECLARE today TIMESTAMP DEFAULT CURRENT_DATE;
SELECT today, filmtypeId, pikkus
from film
